    ...
    <section id="projects" className="py-24">
      ...
      <div className="mb-12">
        <div className="flex items-end justify-between">
          <div>
            ...
            <div className="mt-2 h-1 w-24 bg-accent"></div>
          </div>
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
        {projects.map((project, index) => (
          ...
          <Link href={project.link} key={index} target="_blank" rel="noopener noreferrer" className="block h-full">
            <div className="group flex h-full flex-col border border-border-gray bg-main-gray transition-transform duration-300 hover:-translate-y-2">
              ...
              <div className="flex flex-grow flex-col p-4">
                <h3 className="mb-2 text-2xl font-semibold">
                  {project.title} <span className="text-text-dark">| {project.year}</span>
                </h3>
